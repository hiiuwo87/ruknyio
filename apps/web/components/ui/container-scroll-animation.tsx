...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-6 sm:-mt-12 mx-auto h-[18rem] sm:h-[24rem] md:h-[40rem] w-full border-2 sm:border-4 border-[#6C6C6C] p-1.5 sm:p-2 md:p-6 bg-[#222222] rounded-2xl sm:rounded-[30px] shadow-2xl"
    >
